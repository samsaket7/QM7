...
class AEPDGP:
    ...
    def train(self, X_train, y_train, X_test, y_test, no_epochs, n_per_mb,
        ...
        try:
            ...
            while (not check):
                ...
                if compute_test:
                    ...
                    test_maei  = compute_test_error_mae(y_test, my, self.lik, median=False)
                    print "\t logZ: %.5f, test mnll: %.5f, test rms: %.5f, test mae: %.5f" % (energy, test_nlli, test_rmsi,test_maei)
        ...
        return test_nll, test_rms, test_mae, train_ll
